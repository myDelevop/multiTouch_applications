		...
		keyboardButton.addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent ae) {
				...
				case TapEvent.TAPPED:
			        ...
			        MTSvgButton flickrButton = new MTSvgButton( app, "examples"+ MTApplication.separator  + "advanced" + MTApplication.separator +  "flickrMT" + MTApplication.separator + "data" + MTApplication.separator
									+ "Flickr_Logo.svg");
