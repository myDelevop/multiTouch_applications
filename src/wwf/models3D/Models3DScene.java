...
//	private String modelsPath = System.getProperty("user.dir") + File.separator + "examples" +  File.separator +"advanced"+ File.separator + "models3D"  + File.separator + "data" +  File.separator;
	private String modelsPath = 
	        ...
	        "wwf" + MTApplication.separator  + "models3D"  + MTApplication.separator + "data" +  MTApplication.separator;

	public Models3DScene(MTApplication mtApplication, String name) {
		super(mtApplication, name);
		mtApp = mtApplication;
		
		MTRectangle r = new MTRectangle(mtApp,200,200,200,200);
		...
		//Loads 3ds model
		MTTriangleMesh[] meshes = ModelImporterFactory.loadModel(mtApplication, modelsPath + "jazz_Obj" + MTApplication.separator + "wolf-obj.obj", 180, true, false );
