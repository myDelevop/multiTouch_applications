...
public class MTImageCustomized extends MTImage {
	...
	/** The minimum width threshoald. */
	private float minimumWidthThreshoald = 250;

	/** The maximum width threshoald. */
	private float maximumWidthThreshoald = 2000;
	...
	/* (non-Javadoc)
	 * @see org.mt4j.components.MTComponent#scaleGlobal(float, float, float, org.mt4j.util.math.Vector3D)
	 */
	@Override
	public void scaleGlobal(float X, float Y, float Z, Vector3D scalingPoint) {
		System.out.println("X: " + X + " WIDTH: " + this.getWidthXYGlobal() + " Scaling point: " +scalingPoint);
